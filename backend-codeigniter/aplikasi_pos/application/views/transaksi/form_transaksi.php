                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-header">
                            Mozarella Malang <small>Transaksi</small>
                        </h2>
                    </div>
                </div> 
                <!-- /. ROW  -->
                            ...
                            <div class="panel-body">
                                <?php echo form_open('transaksi', array('class'=>'form-horizontal')); ?>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nama Mozarella</label>
                                        <div class="col-sm-10">
                                          <input list="barang" name="barang" placeholder="Pilih Nama Mozarella" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
