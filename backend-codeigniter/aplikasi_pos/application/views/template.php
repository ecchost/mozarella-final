    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">Mozarella Malang</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'kategori'?>"><i class="fa fa-desktop"></i> Kategori Mozarella</a>
                    </li>
					<li>
                        <a href="<?php echo base_url().'barang'?>"><i class="fa fa-bar-chart-o"></i> Data Mozarella</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p>Website : <a href="http://Mozarella-Malang.com" target="_blank">Mozarella Malang</a></p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
    <!-- /. WRAPPER  -->
